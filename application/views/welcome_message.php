...
<body class="index-page">
	<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-MXM8KC7M" height="0" width="0"
			style="display:none;visibility:hidden"></iframe></noscript>

	<header id="header" class="header d-flex align-items-center fixed-top">
		<div class="container-fluid container-xl position-relative d-flex align-items-center">

			<a href="javascript:;" class="logo d-flex align-items-center me-xl-0 me-auto">
				<!-- Uncomment the line below if you also wish to use an image logo -->
				<img src="<?= site_url() ?>assets/img/logo-light.png" alt="logo-light">
				<!-- <h1 class="sitename">Arsha</h1> -->
			</a>

			<nav id="navmenu" class="navmenu mx-xl-auto">
				<ul>
					<!-- <li class="dropdown"><a href="javascript:;"><span>Dropdown</span> <i class="bi bi-chevron-down toggle-dropdown"></i></a>
						<ul>
							<li><a href="javascript:;">Dropdown 1</a></li>
							<li class="dropdown"><a href="javascript:;"><span>Deep Dropdown</span> <i
									class="bi bi-chevron-down toggle-dropdown"></i></a>
								<ul>
								<li><a href="javascript:;">Deep Dropdown 1</a></li>
								<li><a href="javascript:;">Deep Dropdown 2</a></li>
								<li><a href="javascript:;">Deep Dropdown 3</a></li>
								<li><a href="javascript:;">Deep Dropdown 4</a></li>
								<li><a href="javascript:;">Deep Dropdown 5</a></li>
								</ul>
							</li>
				...
				<div class="row">
					...
					<div class="col-lg-5 col-md-12 col-sm-12">
						<div class="extra-contact-icons">
							<a href="#" class="enquireNow" title="enquire"><i class="fas fa-file-signature"></i></a>
	...
	<!-- Bootstrap Modal -->
	<div class="modal fade" id="flightDealModal" tabindex="-1" aria-labelledby="flightDealModalLabel"
		aria-hidden="true">
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content border-0 rounded shadow">
				<div class="modal-body p-4 text-center">
					...
					<img src="<?= site_url() ?>assets/img/chartered-flight.png" alt="flight" srcset="">
					<h2 class="fw-bold my-3">Still Searching for the Best Flight Deal?</h2>
					<h4 class="text-muted fw-semibold mb-3">USA to India Round Trip from Just <span
							class="text-secondary">$999*</span></h4>
	...
	<main class="main">
              ...
              Expertise.</h3> -->
					...
					<div class="col-lg-6 order-1 order-lg-2 hero-img" data-aos="zoom-out" data-aos-delay="200">
						...
						<div class="text-center">
							<h2 class="mb-2 fs-1 roundtripTitle">24/7 Urgent Booking Available</h2>
						</div>
						<div class="mb-3 text-center">
							<div class="form-check form-check-inline">
								<input class="form-check-input fs-4" type="radio" name="trip_type" id="roundTrip"
									value="Round Trip" checked />
								<label class="form-check-label fw-medium fs-4" for="roundTrip">Round Trip</label>
							</div>
							<div class="form-check form-check-inline">
								<input class="form-check-input fs-4" type="radio" name="trip_type" id="oneWay"
									value="One Way" />
				...
				<div class="swiper init-swiper">
					...
					<div class="swiper-wrapper align-items-center">
						<div class="swiper-slide"><img src="<?= site_url() ?>assets/img/clients/1.png" class="img-fluid"
								alt=""></div>
						<div class="swiper-slide"><img src="<?= site_url() ?>assets/img/clients/2.png" class="img-fluid"
								alt=""></div>
						<div class="swiper-slide"><img src="<?= site_url() ?>assets/img/clients/3.png" class="img-fluid"
								alt=""></div>
						<div class="swiper-slide"><img src="<?= site_url() ?>assets/img/clients/4.png" class="img-fluid"
								alt=""></div>
						<div class="swiper-slide"><img src="<?= site_url() ?>assets/img/clients/5.png" class="img-fluid"
								alt=""></div>
						<div class="swiper-slide"><img src="<?= site_url() ?>assets/img/clients/6.png" class="img-fluid"
								alt=""></div>
						<div class="swiper-slide"><img src="<?= site_url() ?>assets/img/clients/7.png" class="img-fluid"
								alt=""></div>
						<div class="swiper-slide"><img src="<?= site_url() ?>assets/img/clients/8.png" class="img-fluid"
								alt=""></div>
					</div>
				</div>
						...
						<div class="d-flex overflow-x-auto white-space-nowrap">
							<div class=" step-wrapper mb-4">
								...
								<div class="text-center">
									...
									<p class="mb-0">Your booking is secured within minutes! <br> E-tickets are sent
										instantly to your email <br> and WhatsApp for a smooth start.</p>
								</div>
							</div>
							...
							<div class=" step-wrapper mb-4">
								...
								<div class="text-center">
									...
									<p class="mb-0">We handle seat preferences, meal choices, <br> extra baggage,
										wheelchair assistance, <br> and special requests to make your journey
										comfortable.</p>
								</div>
							</div>
							...
							<div class=" step-wrapper mb-4">
								...
								<div class="text-center">
									...
									<p class="mb-0">Get live flight tracking, gate change notifications,<br>delay
										alerts, and check-in reminders – always on time.</p>
								</div>
							</div>
							...
							<div class=" step-wrapper mb-4">
								...
								<div class="text-center">
									...
									<p class="mb-0">Our team is on WhatsApp or call round-the-clock<br>to assist with
		...
		<section id="work-process" class="work-process section light-background">
          ...
          <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div class="steps-item">
              <div class="steps-image">
                <img src="<?= site_url() ?>assets/img/services/1.jpg" alt="Step 1" class="img-fluid" loading="lazy">
              </div>
              <div class="steps-content">
                <div class="steps-number">01</div>
                <h3>USA to Ahmedabad</h3>
                <a href="javascript:;" class="btn-getstarted">Call Us to Book</a>
          ...
          <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="300">
            <div class="steps-item">
              <div class="steps-image">
                <img src="<?= site_url() ?>assets/img/services/2.jpg" alt="Step 2" class="img-fluid" loading="lazy">
              </div>
              <div class="steps-content">
          ...
          <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="400">
            <div class="steps-item">
              <div class="steps-image">
                <img src="<?= site_url() ?>assets/img/services/3.jpg" alt="Step 3" class="img-fluid" loading="lazy">
              </div>
              <div class="steps-content">
          ...
          <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="500">
            <div class="steps-item">
              <div class="steps-image">
                <img src="<?= site_url() ?>assets/img/services/4.jpg" alt="Step 3" class="img-fluid" loading="lazy">
              </div>
              <div class="steps-content">
          ...
          <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="600">
            <div class="steps-item">
              <div class="steps-image">
                <img src="<?= site_url() ?>assets/img/services/5.jpg" alt="Step 3" class="img-fluid" loading="lazy">
              </div>
              <div class="steps-content">
          ...
          <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="700">
            <div class="steps-item">
              <div class="steps-image">
                <img src="<?= site_url() ?>assets/img/services/6.jpg" alt="Step 3" class="img-fluid" loading="lazy">
              </div>
              <div class="steps-content">
          ...
          <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="800">
            <div class="steps-item">
              <div class="steps-image">
                <img src="<?= site_url() ?>assets/img/services/7.jpg" alt="Step 3" class="img-fluid" loading="lazy">
              </div>
              <div class="steps-content">
          ...
          <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="900">
            <div class="steps-item">
              <div class="steps-image">
                <img src="<?= site_url() ?>assets/img/services/8.jpg" alt="Step 3" class="img-fluid" loading="lazy">
              </div>
              <div class="steps-content">
				...
				<div class="row row-cols-2 row-cols-md-3 row-cols-lg-4 g-5 py-lg-5 text-center justify-content-center">
					<div class="col up-down">
						<a href="https://wa.me/19543475414?text=Hi%2C%20I%E2%80%99d%20like%20to%20inquire%20about%20flights%20from%20USA%20to%20Ahmedabad">
					...
					<div class="col up-down">
						<a href="https://wa.me/19543475414?text=Hi%2C%20I%E2%80%99d%20like%20to%20inquire%20about%20flights%20from%20USA%20to%20Bengaluru">
					...
					<div class="col up-down">
						<a href="https://wa.me/19543475414?text=Hi%2C%20I%E2%80%99d%20like%20to%20inquire%20about%20flights%20from%20USA%20to%20Hyderabad">
					...
					<div class="col up-down">
						<a href="https://wa.me/19543475414?text=Hi%2C%20I%E2%80%99d%20like%20to%20inquire%20about%20flights%20from%20USA%20to%20Delhi">
					...
					<div class="col up-down">
						<a href="https://wa.me/19543475414?text=Hi%2C%20I%E2%80%99d%20like%20to%20inquire%20about%20flights%20from%20USA%20to%20Chennai">
					...
					<div class="col up-down">
						<a href="https://wa.me/19543475414?text=Hi%2C%20I%E2%80%99d%20like%20to%20inquire%20about%20flights%20from%20USA%20to%20Kolkata">
					...
					<div class="col up-down">
						<a href="https://wa.me/19543475414?text=Hi%2C%20I%E2%80%99d%20like%20to%20inquire%20about%20flights%20from%20USA%20to%20Amritsar">
				...
				<div class="row gy-4">
					...
					<div class="col-xl-3 col-6 d-flex" data-aos="fade-up" data-aos-delay="100">
						<div class="service-item h-100 w-100 position-relative">
							...
							<p class="d-md-block d-none">On-ground teams in both countries for reliable, real-time
								assistance from
					...
					<div class="col-xl-3 col-6 d-flex" data-aos="fade-up" data-aos-delay="200">
						<div class="service-item h-100 w-100 position-relative">
							...
							<p class="d-md-block d-none"> We help Indian families, students, and professionals with
								personalized care — from finding the best fares to seamless booking.</p>
						</div>
					...
					<div class="col-xl-3 col-6 d-flex" data-aos="fade-up" data-aos-delay="300">
						<div class="service-item h-100 w-100 position-relative">
							...
							<p class="d-md-block d-none">We specialize in long-haul routes with exclusive, unpublished
								round-trip
					...
					<div class="col-xl-3 col-6 d-flex" data-aos="fade-up" data-aos-delay="400">
						<div class="service-item h-100 w-100 position-relative">
							...
							<p class="d-md-block d-none">With ties across 50+ countries, we unlock special fares through
								direct
					...
					<div class="col-xl-3 col-6 d-flex" data-aos="fade-up" data-aos-delay="500">
						<div class="service-item h-100 w-100 position-relative">
							...
							<p class="d-md-block d-none">Found a cheaper fare online? Send a screenshot — we’ll beat it,
								no questions
								asked.</p>
						</div>
					</div><!-- End Service Item -->
					...
					<div class="col-xl-3 col-6 d-flex" data-aos="fade-up" data-aos-delay="600">
						<div class="service-item h-100 w-100 position-relative">
							...
							<p class="d-md-block d-none">Call or WhatsApp real agents anytime. No IVR, no bots. We speak
								English,
					...
					<div class="col-xl-3 col-6 d-flex" data-aos="fade-up" data-aos-delay="700">
						<div class="service-item h-100 w-100 position-relative">
							...
							<p class="d-md-block d-none">Need to reschedule or customize your trip? We’ll handle it
								quickly and
					...
					<div class="col-xl-3 col-6 d-flex" data-aos="fade-up" data-aos-delay="800">
						<div class="service-item h-100 w-100 position-relative">
							...
							<p class="d-md-block d-none">We help you understand baggage rules and get discounted extra
								luggage options
								to save more.</p>
						</div>
					</div><!-- End Service Item -->
			...
			<div class="container" data-aos="fade-up" data-aos-delay="100">
				<div class="row gy-4 flex-nowrap overflow-x-auto mt-2">
					...
					<div class="col-lg-4 col-md-6 aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
						<div class="card h-100">
							<video class="img-fluid" controls muted>
								<source src="https://savitarainfotel.s3.ap-south-1.amazonaws.com/hotelxplore/assets/gogotrips/001.mp4" type="video/mp4">
							...
							<div class="card-body">
								...
								<p class="card-text">
									<span>"I booked my flight from JFK to Ahmedabad with GoGo Trip.
										They gave me the best price compared to other websites. Mohit was very helpful
					...
					<div class="col-lg-4 col-md-6 aos-init aos-animate" data-aos="fade-up" data-aos-delay="200">
						<div class="card h-100">
							<video class="img-fluid" controls muted>
								<source src="https://savitarainfotel.s3.ap-south-1.amazonaws.com/hotelxplore/assets/gogotrips/003.mp4" type="video/mp4">
								Your browser does not support the video tag.
							</video>
							<div class="card-body">
								...
								<p class="card-text">
									<span>"I’ve used GoGo Trips several times for flights between Dublin, Florida, New
										York, Chicago, and California. They’ve saved me well over $1,000 with unbeatable
										service and prices. I highly recommend them — if they were on Trustpilot, I’d
										give them a 12 out of 10!"</span>
								</p>
							</div>
						</div>
					</div><!-- End Team Member -->
					...
					<div class="col-lg-4 col-md-6 aos-init aos-animate" data-aos="fade-up" data-aos-delay="300">
						<div class="card h-100">
							<video class="img-fluid" controls muted>
								<source src="https://savitarainfotel.s3.ap-south-1.amazonaws.com/hotelxplore/assets/gogotrips/2.mp4" type="video/mp4">
								Your browser does not support the video tag.
							</video>
							<div class="card-body">
								...
								<p class="card-text">
									<span>"GoGo Trips made my Ahmedabad–Birmingham flight booking simple, transparent,
										and within budget. Henish Patel’s support and updates were excellent. I highly
										recommend them!"</span>
								</p>
							</div>
						</div>
						...
						<div class="faq-container">
							...
							<div class="faq-item faq-active" data-aos="fade-up" data-aos-delay="200">
								...
								<div class="faq-content">
									<p>We offer unpublished fares, real human support (no bots), and custom itineraries
										you won’t find on
										booking sites.</p>
								</div>
							...
							<div class="faq-item" data-aos="fade-up" data-aos-delay="300">
								...
								<div class="faq-content">
									<p>Yes! Simply call or message us with your trip details. We’ll send your quote in
										minutes—no forms,no
										wait.</p>
								</div>
								<i class="faq-toggle bi bi-chevron-right"></i>
							...
							<div class="faq-item" data-aos="fade-up" data-aos-delay="400">
								...
								<div class="faq-content">
									<p>We assist with cancellations, changes, refunds, and airline credit. Our team is
										available 24/7 to
										support you.</p>
								</div>
								<i class="faq-toggle bi bi-chevron-right"></i>
							...
							<div class="faq-item" data-aos="fade-up" data-aos-delay="500">
								...
								<div class="faq-content">
									<p>Yes. Send us a screenshot—we’ll match or beat most online prices, with better
										service included.</p>
								</div>
								<i class="faq-toggle bi bi-chevron-right"></i>
							</div><!-- End Faq item-->
							...
							<div class="faq-item" data-aos="fade-up" data-aos-delay="600">
								...
								<div class="faq-content">
									<p>Absolutely. We handle wheelchair service, meal requests, medical support, and
							...
							<div class="faq-item" data-aos="fade-up" data-aos-delay="600">
								...
								<div class="faq-content">
									<p>You’ll need a valid passport and an Indian visa or OCI card. We’ll guide you
										through the latest
	...
	<footer id="footer" class="footer">
			...
			<div class="container">
				<div class="row justify-content-center text-center">
					<section class="newsletter-vip">
						...
						<p>Join our VIP list and unlock early access to flash sales, special fares, and exclusive flight
							offers.</p>
						<div class="vip-tags">
		...
		<div class="bg-primary text-white">
			<div class="container footer-top p-4">
				<div class="row gy-4">
					<div class="col-md-4">
						<a href="javascript:;" class="d-flex justify-content-center align-items-center footer-logo">
							<!-- <span class="sitename">Arsha</span> -->
							<img src="<?= site_url() ?>assets/img/logo-4.png" alt="" srcset="" class="mx-auto">
						</a>
					</div>
					<div class="col-md-4 text-center">
						...
						<p class="mt-3 "><strong>Phone:</strong><a href="tel:+1 (229) 329-1796" class="text-white"> +1
								(229) 329-1796</a></p>
						<p class="mt-3 "><strong>WhatsApp:</strong><a href="https://w.meta.me/s/1VjD9RIXA2l48dm"
								class="text-white"> +1954-347-5414</a></p>
					...
					<div class="col-md-4 footer-links d-flex flex-column align-items-center">
						...
						<ul class="d-flex flex-column gap-3">
							<li> <a href="https://gogotripsus.com/terms-conditions/" class="text-white">Terms and
									conditions</a></li>
							<li> <a href="https://gogotripsus.com/privacy-policy/" class="text-white">Privacy Policy</a>
							</li>
						</ul>
					</div>
				</div>
			...
			<div class="container copyright text-center ">
				<p>© <span>Copyright</span> <strong class="px-1 sitename">GoGoTrips</strong> <span>All Rights
						Reserved</span></p>
				<div class="credits">
	...
	<script>
		...
		$('.enquireNow').click(function(event) {
			event.preventDefault(); // Prevent default button behavior
			$('html, body').animate({
				scrollTop: $('.roundtripTitle').offset().top
			}, 800);
		});
	</script>

	<?php $this->load->view('jquery-validation') ?>
